...
namespace CallOut_ConsoleWPF
{
    ...
    public partial class MainWindow : Window, ServiceReference1.CallOut_CodingServiceCallback
    {
        ...
        private static void Log(string logMessage)
        {
            ...
            tw.WriteLine("[" + currentdt.ToString() + "] [Console] \"" + logMessage + "\"");
            tw.Close();
        }
        ...
        public static bool CheckForInternetConnection()
        {
            if (NetworkInterface.GetIsNetworkAvailable()) 
            {
                try
                {
                    ...
                    String host = "8.8.8.8"; //google DNS (if one is not enough can ping with other stable website)
        ...
        private void EmptyDisplay()
        {
            ...
            if (Properties.Settings.Default.CurrentID != null && Properties.Settings.Default.CurrentID != "" && Properties.Settings.Default.isConnected)
            {
                this.txtConsoleName.Text = Properties.Settings.Default.CurrentID;
                foreach (StatsRecord record in StatsRecordList)
                {
        ...
        private void UpdateDetails(CodingIncidentMessage codingIncidentMsg)
        {
            ...
            else
            {
                ...
                MsgAlarmTimer.Interval = wavreader.Length/100; 
        ...
        //Play TTS after message alarm ended
